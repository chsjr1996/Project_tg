...
<head>
    ...
    <script src="{{ asset('js/bootstrap-select/bootstrap-select.min.js') }}" defer></script>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->user_type == 'A')
                                        <a class="dropdown-item" href="{{ url('admin/users') }}">Painel (admin)</a>
                                    @endif
                                    
                                    <a class="dropdown-item" href="{{ url('user/setup', Auth::user()->id) }}">
                                        {{ __('Account Settings') }}
                                    </a>
